...
public partial class GTEditor
{
    ...
    // Palette
    [SerializeField] private List<GTPalette> _palettes = new List<GTPalette>();
    ...
    private void InstatiatePrefab(RaycastHit hit, GameObject prefab, GameObject parent, Vector3 scale)
    {
    ...
    private Vector3 SetScaleMode(Vector3 scale)
    {
